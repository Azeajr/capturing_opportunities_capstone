...
export default function Home() {
  ...
  const applySessionIdToForm = (sessionId: string) => setSessionId(sessionId);
      ...
      <div className="flex flex-col z-10 justify-between gap-10">
        <div className="text-white">
          <h1 className="font-bold">
            Capturing Opportunities: AI-Driven Photo Curation for Wildlife
            Photographer
          </h1>
          <p className="pt-3">
            {isABTestingEnabled ? "U" : "Please select a model and then u"}
            pload images to train the model on. Afterwards, please upload a
        ...
        <div className="p-3 bg-white rounded-md">
          ...
          <div className="h-60">
            {matchingFiles.length === 0 ? (
              <span>
                Please upload training and collection images to see your
                results.
              </span>
            ) : (
        ...
        {matchingFiles.length > 0 && (
          <div className="p-3 bg-white rounded-md">
            ...
            <p className="py-3">
              Please provide feedback on your experience with this application
              by filling out the survey below. If the survey is not appearing
              below, please use this link:{" "}
              <a
                href={`https://docs.google.com/forms/d/e/1FAIpQLSeQlnbvsr72qdba-F_VNMYZbczYNbRYFtBLPpf5pYR1h6rm_g/viewform?usp=pp_url&entry.76857979=${sessionId}`}
                target="_blank"
                className="underline"
              >
                https://forms.gle/KQiakv5j9Q83frJa7
              </a>
            </p>
            <div className="h-80">
              <iframe
                src={`https://docs.google.com/forms/d/e/1FAIpQLSeQlnbvsr72qdba-F_VNMYZbczYNbRYFtBLPpf5pYR1h6rm_g/viewform?usp=pp_url&entry.76857979=${sessionId}`}
                width="100%"
                height="100%"
              >
                Loading…
